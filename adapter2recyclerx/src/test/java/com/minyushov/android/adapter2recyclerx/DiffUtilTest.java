...
import static com.minyushov.android.adapter2recyclerx.DiffUtil.calculateDiff;
...
public class DiffUtilTest {
  ...
  public void testDisableMoveDetection() {
    initWithSize(5);
    move(0, 4);
    List<Item> applied = applyUpdates(mBefore, calculateDiff(mCallback, false));
  ...
  private void check() {
    DiffUtil.DiffResult result = calculateDiff(mCallback);
    log("before", mBefore);
    log("after", mAfter);
